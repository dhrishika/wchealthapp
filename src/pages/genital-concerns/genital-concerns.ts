...
/**
 * Generated class for the GenitalConcernsPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-genital-concerns',
  templateUrl: 'genital-concerns.html',
})
export class GenitalConcernsPage {


  ionViewDidLoad() {
    console.log('ionViewDidLoad GenitalConcernsPage');
  }
